...
public class TimeLogActivity extends AppCompatActivity  implements View.OnClickListener, NumberPicker.OnValueChangeListener , TimePickerFragment.OnTimePickedListener {
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == R.id.water_bottle_button) {
            addBottle();

        } else if (id == R.id.water_bottle_button2) {
            updateToBottle();

        } else if (id == R.id.water_glass_button) {
            addGlass();

        } else if (id == R.id.water_glass_button2) {
            updateToGlass();
        ...
        } else if (id == R.id.other_size_button) {
            addDrinkdialog.dismiss();
            showNumberPickerDialog();

        } else if (id == R.id.other_size_button2) {
            updateDrinkDialog.dismiss();
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    androidx.appcompat.app.AlertDialog.Builder builder = new AlertDialog.Builder(TimeLogActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.add_drink) {
            showAddDrinkDialog();
            return true;
        } else if (i == R.id.sort_by_amount_asc) {
            sortBy = db.sortByAmountAsc();

        } else if (i == R.id.sort_by_amount_desc) {
            sortBy = db.sortByAmountDesc();

        } else if (i == R.id.sort_by_time_ASC) {
            sortBy = db.sortByTimeAsc();

        } else if (i == R.id.sort_by_time_desc) {
